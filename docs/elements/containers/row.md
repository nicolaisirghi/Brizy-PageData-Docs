...
The `Row` element supports hover effects for background-related properties. These properties control how the row appears when users hover over it.

**Background hover keys:**

- `hoverBgColorHex`: The background color of the row on hover in hexadecimal format.
...
- `hoverBoxShadow`: Box shadow for the row on hover. ("", "on","outset")
...
- `hoverBrightness`: The brightness of the row on hover, defined as a number in percent (e.g., `100`).
- `hoverHue`: The hue of the row on hover, defined as a number in degrees (0-360).
- `hoverSaturation`: The saturation of the row on hover, defined as a number in percent (e.g., `100`).
- `hoverContrast`: The contrast of the row on hover, defined as a number in percent (e.g., `100`).
