...
The example above shows a `Cloneable` containing three `Button` elements. When rendered, these buttons will appear inline, allowing users to duplicate them as needed.
